  ...
  return (
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <p className={styles.sub}>Organize seus plantões sem stress</p>
        ...
        <button className={styles.btnGoogle} onClick={handleGoogleLogin}>
          <svg width="18" height="18" viewBox="0 0 18 18">
            ...
            <path
              fill="#FBBC05"
              d="M4.51 10.52A4.8 4.8 0 0 1 4.26 9c0-.53.09-1.04.25-1.52V5.41H1.88A8 8 0 0 0 .98 9c0 1.29.31 2.51.9 3.59l2.63-2.07z"
            />
            <path
              fill="#EA4335"
